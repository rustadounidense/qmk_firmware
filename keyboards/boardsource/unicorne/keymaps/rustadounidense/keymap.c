...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EN] = LAYOUT_split_3x6_3(
    ...
    KC_NO    ,    LT(_SYM,KC_Z),      KC_X,               KC_C,               KC_V,               KC_B,             /**/  KC_N,                   KC_M,                 MT(MOD_HYPR,KC_COMMA),KC_DOT,             LT(_SYM,KC_SCLN),      TO(_RU),
                                                          CW_TOGG,            LT(_NUM,KC_SPACE),  LT(_FUN, KC_TAB), /**/  MT(MOD_HYPR,KC_ENTER),  LT(_NAV,KC_BSPC), LT(_KBD,KC_CAPS)
  ),
  // -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  [_NUM] = LAYOUT_split_3x6_3(
    ...
    KC_NO,        OSM(MOD_LGUI),      OSM(MOD_LALT),      OSM(MOD_LCTL),      OSM(MOD_LSFT),      KC_NO,                  KC_0,                   KC_1,                 KC_2,                 KC_3,               KC_PLUS,              KC_MINUS,
