...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUM] = LAYOUT_split_3x6_3(
    ...
    KC_TRNS,    OSM(MOD_LGUI),      OSM(MOD_LALT),      OSM(MOD_LCTL),          OSM(MOD_LSFT),      LCTL(KC_6),             KC_DOT,                 KC_1,               KC_2,                 KC_3,               KC_MINUS,               KC_TRNS,
    KC_TRNS,    KC_LBRC,            KC_LABK,            KC_RABK,                KC_RBRC,            KC_NO,                  KC_BSLS,                KC_4,               KC_5,                 KC_6,               KC_SLASH,               KC_TRNS,
  ...
  [_SYM] = LAYOUT_split_3x6_3(
    ...
    KC_NO,      OSM(MOD_LGUI),      OSM(MOD_LALT),      OSM(MOD_LCTL),          OSM(MOD_LSFT),      KC_NO,                  KC_NO,                  KC_LPRN,            KC_LCBR,            KC_RCBR,              KC_RPRN,                KC_NO,
  ...
  [_SYS] = LAYOUT_split_3x6_3(
    KC_CAPS,    KC_NO,              KC_NO,              KC_NO,                  KC_NO,              KC_NO,            /**/  KC_NO,                  KC_NO,              KC_BRIGHTNESS_DOWN, KC_BRIGHTNESS_UP,   KC_NO,                  KC_NO,
    CW_TOGG,    KC_NO,              KC_NO,              KC_NO,                  KC_NO,              KC_NO,                  KC_NO,                  KC_NO,              KC_AUDIO_VOL_DOWN,  KC_AUDIO_VOL_UP,    KC_NO,                  KC_NO,
