...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUM] = LAYOUT_split_3x6_3(
    LCTL(KC_6),     LCTL(KC_1),             LCTL(KC_2),             LCTL(KC_3),             LCTL(KC_4),         LCTL(KC_5),       /**/  KC_GRAVE,               KC_7,                 KC_8,                 KC_9,               KC_EQUAL,               KC_NO,
    OSM(MOD_HYPR),  OSM(MOD_LGUI),          OSM(MOD_LALT),          OSM(MOD_LCTL),          OSM(MOD_LSFT),      LCTL(KC_6),       /**/  KC_DOT,                 KC_1,                 KC_2,                 KC_3,               KC_MINUS,               KC_NO,
  ...
  [_SYM] = LAYOUT_split_3x6_3(
    KC_NO,          KC_NO,                  KC_NO,                  KC_NO,                  KC_NO,              KC_NO,            /**/  KC_NO,                  KC_LCBR,              KC_LBRC,              KC_RBRC,            KC_RCBR,                KC_NO,
    KC_NO,          KC_LGUI,                KC_LOPT,                KC_LCTL,                KC_LSFT,            KC_NO,            /**/  KC_NO,                  KC_NO,                KC_LPRN,              KC_RPRN,            KC_NO,                  KC_NO,
