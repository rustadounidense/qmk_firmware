...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EN] = LAYOUT_split_3x6_3(
    ...
    LT(_KBD,KC_NO), KC_Z,                   KC_X,                   KC_C,                   KC_V,               KC_B,             /**/  KC_N,               KC_M,                 KC_COMMA,             KC_DOT,             KC_SCLN,               TO(_RU),
  ...
  [_SYM] = LAYOUT_split_3x6_3(
    KC_NO,          KC_NO,                  KC_NO,                  KC_NO,                  KC_NO,              KC_NO,            /**/  KC_PLUS,            KC_PIPE,              KC_LCBR,              KC_RCBR,            KC_EQUAL,            KC_MINUS,
    KC_NO,          KC_LGUI,                KC_LOPT,                KC_LCTL,                KC_LSFT,            KC_NO,                  KC_ASTR,            KC_BSLS,              KC_LPRN,              KC_RPRN,            KC_DOT,              KC_SLASH,
