...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EN] = LAYOUT_split_3x6_3(
    KC_GRAVE,       KC_Q,                   KC_W,                   KC_E,                   KC_R,               KC_T,             /**/  KC_Y,                   KC_U,                 KC_I,                 KC_O,               KC_P,                   KC_NO,
    ...
    KC_NO,          KC_Z,                   KC_X,                   KC_C,                   KC_V,               KC_B,             /**/  KC_N,                   KC_M,                 KC_COMMA,             KC_DOT,             KC_SCLN,                TO_RU,
                                                                    // -------------------------------------------------------------------------------------------------------------------- //
                                                                    LT(_FUN,KC_ESC),        LT(_NUM,KC_SPACE),  LT(_SYM,KC_TAB),  /**/  MT(MOD_HYPR,KC_ENTER),  LT(_NAV,KC_BSPC),     LT(_KBD,KC_DEL)
  ),
  // =============================================================================================================================================================================================================================================================
  ...
  [_NUM] = LAYOUT_split_3x6_3(
    ...
    KC_CAPS,        OSM(MOD_LGUI),          OSM(MOD_LALT),          OSM(MOD_LCTL),          OSM(MOD_LSFT),      KC_NO,            /**/  KC_0,                   KC_1,                 KC_2,                 KC_3,               KC_DOT,                 KC_NO,
