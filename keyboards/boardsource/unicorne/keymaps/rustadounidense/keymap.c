...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EN] = LAYOUT_split_3x6_3(
    ...
    KC_NO    ,    KC_Z,               KC_X,               LT(_SYM,KC_C),      KC_V,               KC_B,             /**/  KC_N,                   KC_M,                 LT(_SYM,KC_COMMA),    KC_DOT,             KC_SCLN,               TO(_RU),
                                                          KC_ESCAPE,          LT(_NUM,KC_SPACE),  LT(_FUN, KC_TAB), /**/  MT(MOD_HYPR,KC_ENTER),  LT(_NAV,KC_BSPC),     LT(_KBD,KC_CAPS)
  ),
  // -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
