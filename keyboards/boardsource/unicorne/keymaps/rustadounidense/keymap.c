...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EN] = LAYOUT_split_3x6_3(
    ...
    CW_TOGG,        MT(MOD_LGUI,KC_A),  MT(MOD_LALT,KC_S),  MT(MOD_LCTL,KC_D),  MT(MOD_LSFT,KC_F),  KC_G,             /**/  KC_H,               MT(MOD_RSFT,KC_J),    MT(MOD_RCTL,KC_K),    MT(MOD_RALT,KC_L),  MT(MOD_RGUI,KC_QUOTE), KC_SLASH,
    LT(_KBD,KC_NO), KC_Z,               KC_X,               KC_C,               KC_V,               KC_B,             /**/  KC_N,               KC_M,                 LT(_SYM,KC_COMMA),    KC_DOT,             KC_SCLN,               TO(_RU),
  ...
  [_NUM] = LAYOUT_split_3x6_3(
    KC_NO,          LCTL(KC_1),         LCTL(KC_2),         LCTL(KC_3),         LCTL(KC_4),         LCTL(KC_5),       /**/  KC_PLUS,            KC_7,                 KC_8,                 KC_9,               KC_EQUAL,             KC_MINUS,
    OSM(MOD_HYPR),  OSM(MOD_LGUI),      OSM(MOD_LALT),      OSM(MOD_LCTL),      OSM(MOD_LSFT),      LCTL(KC_6),             KC_ASTR,            KC_1,                 KC_2,                 KC_3,               KC_DOT,               KC_SLASH,
    KC_NO,          KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,                  KC_COMMA,           KC_4,                 KC_5,                 KC_6,               KC_COLN,              KC_UNDS,
                                                            KC_NO,              KC_NO,              KC_NO,                  KC_TRNS,            KC_0,                 KC_TAB
  ),
  // -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  [_SYM] = LAYOUT_split_3x6_3(
    KC_NO,          KC_CIRC,            KC_PERC,            KC_AMPR,            KC_QUES,            KC_NO,            /**/  KC_PLUS,            KC_PIPE,              KC_LCBR,              KC_RCBR,            KC_EQUAL,            KC_MINUS,
    KC_NO,          KC_DLR,             KC_HASH,            KC_AT,              KC_EXLM,            KC_NO,                  KC_ASTR,            KC_BSLS,              KC_LPRN,              KC_RPRN,            KC_DOT,              KC_SLASH,
    KC_NO,          KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,                  KC_LABK,            KC_RABK,              KC_LBRC,              KC_RBRC,            KC_COLN,             KC_UNDS,
                                                            KC_TRNS,            KC_TRNS,            KC_TRNS,                KC_TRNS,            KC_TRNS,              KC_TRNS
  ),
  // -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  [_NAV] = LAYOUT_split_3x6_3(
    KC_NO,          KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,            /**/  KC_HOME,            LGUI(KC_LEFT),        KC_UP,                LGUI(KC_RIGHT),     KC_PAGE_UP,           KC_NO,
    KC_NO,          KC_LGUI,            KC_LOPT,            KC_LCTL,            KC_LSFT,            KC_NO,                  KC_END,             KC_LEFT,              KC_DOWN,              KC_RIGHT,           KC_PGDN,              OSM(MOD_HYPR),
