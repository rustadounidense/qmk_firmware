...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EN] = LAYOUT_split_3x6_3(
    ...
    KC_NO,      KC_Z,               KC_X,               MT(MOD_HYPR,KC_C),      KC_V,               KC_B,             /**/  KC_N,                   KC_M,               MT(MOD_HYPR,KC_COMMA),KC_DOT,             KC_SCLN,               TO(_RU),
                                                        KC_ESC,                 LT(_NUM,KC_SPACE),  LT(_FUN, KC_TAB), /**/  MT(MOD_HYPR, KC_ENTER), LT(_NAV,KC_BSPC),   KC_DEL
  ),
  // --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  [_NUM] = LAYOUT_split_3x6_3(
    KC_TRNS,    KC_LPRN,            KC_LCBR,            KC_RCBR,                KC_RPRN,            KC_NO,            /**/  KC_GRAVE,               KC_7,               KC_8,                 KC_9,               KC_EQUAL,               KC_TRNS,
    KC_TRNS,    OSM(MOD_LGUI),      OSM(MOD_LALT),      OSM(MOD_LCTL),          OSM(MOD_LSFT),      CW_TOGG,                KC_DOT,                 KC_1,               KC_2,                 KC_3,               KC_MINUS,               KC_TRNS,
}    KC_TRNS,    KC_LBRC,            KC_LABK,            KC_RABK,                KC_RBRC,            KC_CAPS,                KC_BSLS,                KC_4,               KC_5,                 KC_6,               KC_SLASH,               KC_TRNS,
...
//  ),
  ...
  [_NAV] = LAYOUT_split_3x6_3(
    KC_TRNS,    KC_LPRN,            KC_LCBR,            KC_RCBR,                KC_RPRN,            KC_NO,            /**/  KC_HOME,                LGUI(KC_LEFT),      KC_UP,                LGUI(KC_RIGHT),     KC_PAGE_UP,             KC_TRNS,
    KC_TRNS,    KC_LGUI,            KC_LOPT,            KC_LCTL,                KC_LSFT,            KC_NO,                  KC_END,                 KC_LEFT,            KC_DOWN,              KC_RIGHT,           KC_PGDN,                KC_TRNS,
    KC_NO,      KC_LBRC,            KC_LABK,            KC_RABK,                KC_RBRC,            KC_NO,                  KC_NO,                  LGUI(KC_LBRC),      RCTL(KC_UP),          LGUI(KC_RBRC),      KC_NO,                  KC_NO,
                                                        KC_TRNS,                KC_SPACE,           KC_TAB,                 KC_TRNS,                KC_TRNS,            KC_TRNS
  ),
  // --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  [_FUN] = LAYOUT_split_3x6_3(
    KC_TRNS,    LCTL(KC_1),         LCTL(KC_2),         LCTL(KC_3),             LCTL(KC_4),         LCTL(KC_5),       /**/  KC_NO,                  KC_F7,              KC_F8,                KC_F9,              KC_F10,                 KC_NO,
